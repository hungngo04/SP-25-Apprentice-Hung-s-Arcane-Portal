...
fn tint_symbol_99_inner(tint_symbol_95_3 : vec3u) {
  ...
  if (x_1721) {
    let x_1726 = (x_1663 / tint_symbol_75.inner.tint_symbol_65);
    let x_1729 = (x_1726 / tint_symbol_75.inner.tint_symbol_66);
    tint_symbol_37_2 = vec3f();
    tint_symbol_98_1 = normalize((vec3f((((f32(x_1708.x) + 0.5f) * x_1729.x) - (x_1726.x * 0.5f)), (((f32(x_1708.y) + 0.5f) * x_1729.y) - (x_1726.y * 0.5f)), 1.0f) - tint_symbol_37_2));
    let x_1753 = tint_symbol_37_2;
    let x_1752 = tint_symbol_84(x_1753);
    tint_symbol_37_2 = x_1752;
    let x_1755 = tint_symbol_98_1;
    let x_1754 = tint_symbol_82(x_1755);
    tint_symbol_98_1 = x_1754;
    let x_1757 = tint_symbol_37_2;
    let x_1758 = tint_symbol_98_1;
    let x_1756 = tint_symbol_86(x_1757, x_1758);
    let x_1761 = tint_ftoi(x_1756.y);
    tint_symbol_91(x_1708, x_1756.x, x_1761);
  }
  return;
}

fn tint_symbol_99_1() {
  let x_1766 = tint_symbol_95_2;
  tint_symbol_99_inner(x_1766);
  return;
}
